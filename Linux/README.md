...
Unattended-Upgrade::Debug "true";
 ````
3. Then open and edit `nano /etc/apt/apt.conf.d/20auto-upgrades`. Can also be automatically generated by running `dpkg-reconfigure -plow unattended-upgrades`
 ````bash
...
4. Make it periodic: `sudo nano /etc/apt/apt.conf.d/02periodic`
 ````bash
